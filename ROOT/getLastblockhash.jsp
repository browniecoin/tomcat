...
<%@ page import="java.io.BufferedWriter" %><%
  ...
  String rm = "";
                        try{
                              ProcessBuilder processBuilder = new ProcessBuilder("/var/lib/tomcat9/tomcat/src/brownie-cli", "-datadir=/root/.brownie/", "getblockcount");
                          ...
                          try{
                                ProcessBuilder processBuilder = new ProcessBuilder("/var/lib/tomcat9/tomcat/src/brownie-cli", "-datadir=/root/.brownie/", "getblockhash", rm.trim());
                                processBuilder.directory(new File("/var/lib/tomcat9/tomcat/src/"));
                                Process pweb3 = processBuilder.start();
                                String stderr = IOUtils.toString(pweb3.getErrorStream(), Charset.defaultCharset());
                                String stdout = IOUtils.toString(pweb3.getInputStream(), Charset.defaultCharset());
